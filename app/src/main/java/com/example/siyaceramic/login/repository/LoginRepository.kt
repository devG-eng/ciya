package com.example.siyaceramic.login.repository
...
class LoginRepository (private val apiService: ApiService) {
    ...
    suspend fun loginUser(loginReqModel: LoginReqModel, apiName: String): ResourceStatus<*> {

        kotlin.runCatching {
            apiService.loginUser(apiName, loginReqModel).awaitResponse()
        }.onSuccess {
